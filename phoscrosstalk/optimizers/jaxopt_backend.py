...
def run_single_optimisation_jaxopt(
    ...
    Args:
        ...
        solver_kind: One of "lbfgsb" (SciPy L-BFGS-B via JAXopt wrapper,
            recommended) or "projected_gradient" (pure-JAX projected GD).
        stepsize: Step size for "projected_gradient" only; ignored for "lbfgsb".
        acceleration: Enable Nesterov acceleration for "projected_gradient"
            (FISTA-style).
